...
const FooterSection = () => {
  ...
  const email = footer ? footer.email : "atendimento@lsholdings.com.br";
  const phone1 = footer ? footer.phone1 : "+55 (48) 99662-4084";
  const phone2 = footer ? footer.phone2 : "(48) 3030-7322";
  const address = footer ? footer.address : "Rua Raimundo Bridon, 223\nItaguaçu, Florianópolis - SC\nCEP: 88085-370";
  const instagramUrl = footer ? footer.instagram_url : "https://instagram.com/ls.holding";
  const workLabel = footer ? footer.work_button_label : "TRABALHE CONOSCO";
  const workUrl = footer ? footer.work_button_url : "https://forms.monday.com/forms/0b7c6651a7ffcc5da61f9fa588b1fbd8?r=use1";
  const copyright = footer ? footer.copyright : "© 2025 LS Holdings. Todos os direitos reservados.";
            ...
            <ul className="space-y-1 text-slate-400 leading-relaxed">
              ...
              {phone1 && (
                <li className="flex items-center justify-center md:justify-start gap-3">
                  ...
                  <a href={`https://api.whatsapp.com/send/?phone=${phone1.replace(/\D/g, "")}&text&type=phone_number&app_absent=0`} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{phone1}</a>
                </li>
              )}
              {phone2 && (
