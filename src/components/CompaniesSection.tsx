                ...
                >
                  <div className="relative h-[200px] md:h-[250px] lg:h-full lg:min-h-[300px] block">
                    ...
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                      {hasVideo && (
                        <a href={company.video_url} target="_blank" rel="noopener noreferrer" className="w-12 h-12 md:w-16 md:h-16 border-2 border-white/30 rounded-full flex items-center justify-center text-white backdrop-blur-sm group-hover:scale-110 transition-transform cursor-pointer">
